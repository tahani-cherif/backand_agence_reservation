...
// relation de la table reservation bus
 ...
 DB.hotel.hasMany(DB.reservation_bus,{foreignkey:'user'})//relation entre table user et reservation 
 DB.reservation_bus.belongsTo(DB.hotel,{foreignkey:'user'})//relation entre table reservation et user 
 ...
 DB.hotel.hasMany(DB.reservation_evenement,{foreignkey:'id_user'})//relation entre table user et reservation_evenement 
 DB.reservation_evenement.belongsTo(DB.hotel,{foreignkey:'id_user'})//relation entre table reservation_evenement et user 
