...
router.get('/countreservationtransport',reservation_tarnsport_controller.countReservation_tarnsport)
router.get('/countreservationtransportbus',reservation_tarnsport_controller.countReservation_tarnsportbus)
router.get('/countreservationtransportavion',reservation_tarnsport_controller.countReservation_tarnsportavion)
